...
public class Monster : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            CharacterHit(AttackPoint);  //Health -= AttackPoint; //체력 포인트를 공격 포인트 만큼 감소 시켜준다. (Health = Health - AttackPoint)ss
        }
        CheckDeath();//함수 호출
        ...
        public svoid CharacterHit(int Damage)//커스텀 데미지를 받는 함수를 사용한다.
    {
